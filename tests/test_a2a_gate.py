...
class TestBlastRadius:
    def test_defaults(self) -> None:
        ...
        assert limits["maxFiles"] == 5 and limits["maxLines"] == 200
...
class TestGeneEligible:
    ...
    def test_no_strategy(self) -> None:
        assert not is_gene_broadcast_eligible({"type": "Gene", "id": "g1", "validation": ["v"]})

    def test_no_validation(self) -> None:
        assert not is_gene_broadcast_eligible({"type": "Gene", "id": "g1", "strategy": ["s"]})
