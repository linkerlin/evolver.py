...
| 项 | 优先级 | 说明 |
|---|---|---|
| ja/ko README 扩展 | P3 | ✅ **已完成（2026-08-11）**：补 Implementation Status（v1.94.0）+ 环境变量表，140 行 |
| G8 工程面 | P3 | ✅ **已完成（2026-08-11）**：internal-proxy-env 脚本 + PR 模板 + CI 版本断言 |
| 全量测试提速（`-m "not slow"` 分轨） | P3 | ✅ **已完成（2026-08-11）**：23 个慢测试标记 + CI 快慢双轨并行，墙钟 ~10.5→~7min |
